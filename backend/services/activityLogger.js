...
const ActivityType = {
  ...
  EMAIL_CHANGE_VALIDATED: 'email_change_validated',
  EMAIL_CHANGE_ADMIN: 'email_change_admin',
  ...
  COMPANY_EXPORTED: 'company_exported',
  ...
  SUPPLIER_TEMPLATE_CREATED: 'supplier_template_created',
  SUPPLIER_TEMPLATE_UPDATED: 'supplier_template_updated',
  SUPPLIER_TEMPLATE_DELETED: 'supplier_template_deleted',
  SUPPLIER_DOCUMENT_CREATED: 'supplier_document_created',
  SUPPLIER_DOCUMENT_UPDATED: 'supplier_document_updated',
  SUPPLIER_DOCUMENT_DELETED: 'supplier_document_deleted',
  SUPPLIER_DOCUMENT_VIEWED: 'supplier_document_viewed',
  SUPPLIER_DOCUMENT_QUERIED: 'supplier_document_queried',
