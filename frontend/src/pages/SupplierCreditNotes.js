...
const SupplierCreditNotes = () => {
  ...
  const fetchDocuments = useCallback(async () => {
    try {
      ...
      toast.error('Error fetching supplier credit notes');
    } finally {
      setLoading(false);
    }
  ...
  const handleUploadDocuments = async () => {
    ...
    try {
      ...
      formData.append('documentType', 'credit_note');
            ...
            <div className="card-header">
              <div className="row w-100 g-3">
                <div className="col-lg-3 col-md-4 col-12">
                  <h3 className="card-title mb-0">Supplier Credit Notes</h3>
                  <p className="text-secondary m-0">View and manage supplier credit note documents</p>
                </div>
              ...
              <table className="table table-vcenter table-hover">
                ...
                <tbody>
                  {loading ? (
                    ...
                    <tr><td colSpan="7" className="text-center text-muted py-4">No supplier credit notes found</td></tr>
                  ) : (
                    documents.map(doc => (
                      <tr key={doc.id}>
          ...
          <div className="modal-dialog modal-lg modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">Upload Supplier Credit Notes</h5>
                ...
                {uploadResults ? (
                  <div className="text-center py-3">
                    ...
                    <p className="text-info small">
                      The system will automatically detect which supplier each credit note belongs to.
                    </p>
                  </div>
                ) : (
                  <>
                    <div className="alert alert-info">
                      <strong>Auto-Detection:</strong> The system will automatically identify the supplier from each credit note using the Supplier Code or Name.
                    </div>
                    <div className="mb-3">
