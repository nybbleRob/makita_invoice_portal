...
const SupplierStatements = () => {
  ...
  const fetchDocuments = useCallback(async () => {
    try {
      ...
      toast.error('Error fetching supplier statements');
    } finally {
      setLoading(false);
    }
            ...
            <div className="card-header">
              <div className="row w-100 g-3">
                <div className="col-lg-3 col-md-4 col-12">
                  <h3 className="card-title mb-0">Supplier Statements</h3>
                  <p className="text-secondary m-0">View and manage supplier statement documents</p>
                </div>
              ...
              <table className="table table-vcenter table-hover">
                ...
                <tbody>
                  {loading ? (
                    ...
                    <tr><td colSpan="7" className="text-center text-muted py-4">No supplier statements found</td></tr>
                  ) : (
                    documents.map(doc => (
                      <tr key={doc.id}>
                        <td><strong>{doc.invoiceNumber || doc.originalName || '-'}</strong></td>
                        ...
                        <td>{doc.extractedFields?.statementPeriod || '-'}</td>
